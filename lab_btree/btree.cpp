...
void BTree<K, V>::split_child(BTreeNode* parent, size_t child_idx)
{
    ...
    // Assigning Right Child Elements/Child
    ...
    // Assigning Parent the Split Element
    ...
    // for( unsigned long i = 0 ; i < parent->elements.size() ; i++ )
    //   std::cout<<parent->elements[i].key<<std::endl ;

    // for( unsigned long i = 0 ; i < parent->children.size() ; i++ )
    //   std::cout<<parent->children[i]->elements[0].key<<std::endl ;
    // std::cout<<parent->children[0]->elements.size()<<std::endl ;
    // std::cout<<parent->children[1]->elements.size()<<std::endl ;
    // std::cout<<parent->children[0]->elements[0].key<<std::endl ;
    // std::cout<<parent->children[1]->elements[0].key<<std::endl ;
}
...
void BTree<K, V>::insert(BTreeNode* subroot, const DataPair& pair)
{
    ...
    {
      // Traverse to corresponding child
      insert( subroot->children.at(first_larger_idx), pair ) ;

      // Check to see if order is balanced
